...
const MODES: &[(usize, usize, f64)] = &[
  ...
  (0, 2, 5.5201), (3, 1, 6.3802), (1, 2, 7.0156),
  (4, 1, 7.5883), (2, 2, 8.4172), (0, 3, 8.6537),
];
...
pub struct Drum { profile: HashMap<(usize, u64), Vec<f64>> }
impl Default for Drum { fn default() -> Self { Self { profile: HashMap::new() } } }
