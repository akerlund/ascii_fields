...
flow, DLA frost, the Lorenz attractor, drum eigenmodes, and more. There are 84
modes in all.
...
| `cubic-roots` | Roots of monic cubics with linear term restricted to 8th roots of unity |
| `mobius0` | Elliptic Möbius flow on the disk (rotating pole) |
...
| `mobius3` | Flat checkerboard plane bent onto a rolling sphere via stereographic projection |
